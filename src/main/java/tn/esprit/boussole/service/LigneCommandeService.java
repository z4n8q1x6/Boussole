...
public class LigneCommandeService implements crud<LigneCommande> {  // CHANGED: lowercase crud interface
     ...
     */
    @Override
    public void insertone(LigneCommande ligneCommande) throws SQLException {  // CHANGED: method name
        ...
        try (PreparedStatement ps = cnx.prepareStatement(req, Statement.RETURN_GENERATED_KEYS)) {
            ...
            System.out.println("✅ LigneCommandeService.insertone: " + affectedRows + " ligne(s) insérée(s)");
    ...
    @Override
    public void updateone(LigneCommande ligneCommande) throws SQLException {  // CHANGED: method name
    ...
    @Override
    public void deleteone(LigneCommande ligneCommande) throws SQLException {  // CHANGED: method name
    ...
    @Override
    public List<LigneCommande> selectAll(LigneCommande ignored) throws SQLException {  // CHANGED: method signature with parameter
    ...
    public void insertTestData() throws SQLException {
        ...
        List<Commande> commandes = commandeService.selectAll(null);  // CHANGED: added null parameter
        List<Produit> produits = produitService.selectAll(null);  // CHANGED: added null parameter
        ...
        if (!commandes.isEmpty() && !produits.isEmpty()) {
            ...
            if (produits.size() >= 2) {
                ...
                insertone(lc1);  // CHANGED: method name
                insertone(lc2);  // CHANGED: method name
            ...
            if (produits.size() >= 3 && commandes.size() >= 2) {
                ...
                insertone(lc3);  // CHANGED: method name
