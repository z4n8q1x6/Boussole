...
public class franchiseService implements crud<franchise> {
    ...
    public void insertone(franchise franchise) throws SQLException {
        String req = "INSERT INTO franchises (nom, email, telephone, adresse, actif, date_creation, solde_actuel) VALUES (?, ?, ?, ?, ?, ?, ?)";
        try (PreparedStatement ps = cnx.prepareStatement(req, Statement.RETURN_GENERATED_KEYS)) {
            ...
            ps.setTimestamp(6, franchise.getDateCreation() != null ? Timestamp.valueOf(franchise.getDateCreation()) : null);
