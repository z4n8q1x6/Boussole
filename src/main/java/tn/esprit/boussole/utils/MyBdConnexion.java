...
public class MyBdConnexion {
    ...
    // singleton pour creation d'une seul instance : constructeur privé + cree variable ayant mm type de la class+retourner linstance avec une methode getinstance()
