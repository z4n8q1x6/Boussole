...
public class TestModuleC {
  public static void main(String[] args) throws SQLException {
    ...
    System.out.println(
        "Inséré transaction RECETTE id=" + t1.getId() + " montant=" + t1.getMontant());

    transaction t2 = new transaction(dateOct2025, 1500.0, Type.DEPENSE, "Achat fournitures", 1);
    serviceTransaction.insertone(t2);
    System.out.println(
        "Inséré transaction DEPENSE id=" + t2.getId() + " montant=" + t2.getMontant());
    ...
    budget_previsionnel b =
        new budget_previsionnel(
            10, 2025, 2000.0, budget_previsionnel.TypeBudget.LIMITE_DEPENSE, "MARKETING", 1);
    ...
    budget_previsionnel bDuplicate =
        new budget_previsionnel(
            10, 2025, 2000.0, budget_previsionnel.TypeBudget.LIMITE_DEPENSE, "MARKETING", 1);
